...
async function runIntegrationTest() {
  ...
  console.log(`- Coffee: ${coffeeDetails.recordCount} reviews with ${coffeeDetails.schema.length} fields`);
  console.log(`- Whisky: ${whiskyDetails.recordCount} reviews with ${whiskyDetails.schema.length} fields`);
  console.log('='.repeat(60));
  console.log();
